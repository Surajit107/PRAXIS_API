/**
 * YouTube public API controllers (static JSON under `src/json/youtube/`).
 * Not loaded into `public_json_docs` / `db:seed:public`.
 *
 * HTTP mount is intentionally disabled in `src/app.js` (and Swagger paths
 * stripped) because the bundled channel/video payloads are third-party
 * copyrighted content.
 */
